      ...
      <div class="card-body">
        <form action="{{route('berita.prosesUbah')}}" method="post" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            @enderror
            <p></p>
            <img id="tampilFoto" onerror="this.onerror=null;this.src='https://t4.ftcdn.net/jpg/04/73/25/49/360_F_473254957_bxG9yf4ly7OBO5I0O5KABlN930GwaMQz.jpg'" src="{{asset('storage/' . $berita->gambar_berita)}}" alt="" width="15%">
          </div>

          <div class="mb-3">
            <label class="form-label">Isi Berita</label>
            <textarea name="isi_berita" id="editor" class="form-control @error('isi_berita') is-invalid @enderror">{{$berita->isi_berita}}</textarea>
            @error('isi_berita')
            <span style="...">{{$message}}</span>
            @enderror
          </div>

...
@section('content')
  <div class="container-fluid">
    <h1 class="h3 mb-2 text-gray-800">Form Tambah Layanan</h1>
    ...
    <div class="card shadow mb-4">
      ...
      @endif
        ...
        <form action="{{route('layanan.prosesTambah')}}" method="post" enctype="multipart/form-data">
          @csrf
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <select name="id_bagian_layanan" class = "form-control @error('id_bagian_layanan') is-invalid @enderror" id="">
              @foreach($bagian_layanan as $row)
                <option value="{{$row->id_bagian_layanan}}">{{$row->nama_bagian_layanan}}</option>
              @endforeach
            </select>
          ...
          <div class="mb-3">
            ...
            <textarea name="deskripsi_layanan" id="editor" class="form-control @error('deskripsi_layanan') is-invalid @enderror">{{old('deskripsi_layanan')}}</textarea>
